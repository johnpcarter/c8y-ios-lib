...
public struct C8yCustomAssetProcessor {
    ...
    static var _customPropertyCodable: Dictionary<String, C8yCustomAssetDecoder> = Dictionary()
    ...
    public static func registerCustomPropertyClass(property: String, decoder: C8yCustomAssetDecoder) {
    ...
    static func decode(_ key: AssetObjectKey, container: KeyedDecodingContainer<AssetObjectKey>) throws -> C8yCustomAsset {
        ...
        if (C8yCustomAssetProcessor._customPropertyCodable[key.stringValue] == nil) {
            ...
            //return try C8yCustomAssetProcessor._customPropertyCodable[key.stringValue]!.make(key: key, container: try container.nestedContainer(keyedBy: AssetObjectKey.self, forKey: key))
