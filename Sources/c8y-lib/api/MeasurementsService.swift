...
public class C8yMeasurementsService: JcConnectionRequest<C8yCumulocityConnection> {
    ...
    */
	...
	-  returns Publisher to issue list of retrieved Measurements
     */
    ...
    */
    ...
    /**
     ...
     - returns Publisher to indicate success/failure of post operation
    ...
    private func args(_ id: String, pageNum: Int, from: Date, to: Date, reverseOrder: Bool, type: String?) -> String {
        ...
        if (type != nil) {
            path = "\(path)&type=\(type!.addingPercentEncoding(withAllowedCharacters: .alphanumerics)!)"
        }
    ...
    private func args(_ id: String, from: Date, to: Date, reverseOrder: Bool, aggregationType: C8yMeasurementSeries.AggregateType, type: String, series: String) -> String {
        ...
        return "\(C8Y_MEASUREMENTS_API)/series?source=\(id)&series=\(type.addingPercentEncoding(withAllowedCharacters: .alphanumerics)!).\(series.addingPercentEncoding(withAllowedCharacters: .alphanumerics)!)&revert=\(reverseOrder)&dateFrom=\(parseDate(from))&dateTo=\(parseDate(to))&aggregationType=\(aggregationType.rawValue)&pageSize=\(pageSize)"
    }
